       ...
       function getMoviesByFilter(minYear,maxYear,minVote,maxVote,genreId){
        ...
        function parseSimilars(similars){
          ...
          for (var i = 0; i < similars.length; i++){
            ...
            thumbnail.url  = config.base_url.replace("http","https").replace("http","https") + config.logo_sizes[2] +similars[i].poster_path;
        ...
        function parseMovies(movies){
          ...
          let parsedMovies = [];
            for(var i = 0; i < movies.length; i++){
                ...
                parsedMovie.regular_poster =config.base_url.replace("http","https").replace("http","https") + config.poster_sizes[3] + movies[i].poster_path;
                parsedMovie.poster = config.base_url.replace("http","https").replace("http","https").replace("http","https") + config.poster_sizes[4] + movies[i].poster_path;
        ...
        function parseMovie (movie){
          ...
          parsedMovie.full_poster = config.base_url.replace("http","https").replace("http","https").replace("http","https") + config.poster_sizes[4] + movie.poster_path;
